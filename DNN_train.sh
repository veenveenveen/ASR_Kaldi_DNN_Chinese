...
dnn_dir=DNN_tri_8_2000_aligned_layer3_nodes256
...
# DNN hybrid system training parameters
 ...
 --num-jobs-nnet "$train_nj" --cmd "$train_cmd" --num-epochs 15 \
  $train_dir $lang_dir $exp/tri_8_2000_ali $exp/$dnn_dir
...
#steps/nnet2/decode.sh --cmd "$decode_cmd" --nj "$decode_nj" $exp/tri_8_2000/$graph_dir $test_dir $exp/$dnn_dir/$decode_dir | tee $exp/$dnn_dir/$decode_dir/decode.log

steps/nnet2/decode.sh --cmd "$decode_cmd" --nj "$decode_nj" $exp/tri_8_2000/$graph_dir $test_dir $exp/$dnn_dir/$decode_dir
